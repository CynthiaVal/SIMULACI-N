<?php
  ...
  echo "ALGORITMO DE PRODUCTOS MEDIOS";
  echo "<br>";
  echo "**********************************";
  echo "<br>";
  ...
  echo "
    <form action='pro_med.php' method='post' >
        <div class='form-group'>
          <label for='semilla1'>Semilla 1</label>
            <div class='input-group'>
              <input class='form-control'  type='text'  name='semilla1'>
              <br>
            </div>
        </div>
        <div class='form-group'>
          <label for='semilla2'>Semilla 2</label>
            <div class='input-group'>
              <input class='form-control'  type='text'  name='semilla2'>
              <br>
            </div>
        </div>
        <div class='form-group'>
