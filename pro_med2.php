<?php
        ...
        <div class='container'>
            <div class='row'>
                <div class='col-lg-12 text-center'>
                    <h2 class='section-heading'>Algoritmo de Productos Medios</h2>
                    <hr class='primary'>
                </div>
            </div>
        </div>";
  ...
  <div class='container'>
          <div class='row'>
            <div class='col-sm-6' >
              <form action='pro_med2.php' method='post' >
                <div class='form-group'>
                  <label for='semilla1'>Semilla 1</label>
                    <div class='input-group'>
                      ...
                      <input type='text' name='semilla1' class='form-control'  aria-describedby='basic-addon1'>
                    </div>
                </div>
                <div class='form-group'>
                  <label for='semilla2'>Semilla 2</label>
                    <div class='input-group'>
                      ...
                      <input type='text' name='semilla2' class='form-control'  aria-describedby='basic-addon1'>
                    </div>
                </div>
   ...
   if (isset($_POST['semilla1']) and isset($_POST['semilla2'])and isset($_POST['cantidad'])) 
  {
    $xo=$_POST['semilla1'];
    $xi=$_POST['semilla2'];
    $n=$_POST['cantidad'];
