    ...
    echo
      "<!DOCTYPE html>
        ...
        <head>
         ...
         <title>Prueba de la varianza</title>
        ...
        <div class='container'>
            <div class='row'>
                <div class='col-lg-8 col-lg-offset-2 text-center'>
                    <h2 class='section-heading'>PRUEBA DE LA VARIANZA</h2>
                </div>
            </div>
        </div>
    </section>
  ...
  <div class='container'>
          <div class='row'>
            <div class='col-sm-6' >
              ...
              <form action='varianza.php' method='post' >
                ...
                <div class='form-group'>
                  <label for='cs'> X2(a/2)</label>
                    <div class='input-group'>
                      <span class='input-group-addon' id='basic-addon1'><span class='glyphicon glyphicon-star'></span></span>
                      <input type='text' name='superior' class='form-control'  aria-describedby='basic-addon1'>
                    </div>
                </div>
                <div class='form-group'>
                  <label for='ci'> X2((1-a)/2)</label>
                    <div class='input-group'>
                      <span class='input-group-addon' id='basic-addon1'><span class='glyphicon glyphicon-star'></span></span>
                      <input type='text' name='inferior' class='form-control'  aria-describedby='basic-addon1'>
                    </div>
                </div>
...
if (isset($_POST['semilla']) and isset($_POST['multiplicativa']) and isset($_POST['modulo']) and isset($_POST['cantidad']) AND isset($_POST['superior']) and isset($_POST['inferior'])) 
  {
    $xo=$_POST['semilla'];
    ...
    if($v<=$ls and $v>=$li)
    {
      echo"Se acepta que los números tienen una varianza estadistica igual a 0.5";
    }
    else
